 ...
 * @author Avishek
 */
public class javaa extends Language
{
    String code ;
    int timeLimit ;
    String dir ;
    ...
    javaa(String code, int i, String absolutePath, int index) 
    {
        this.code = code ;
        this.timeLimit = i ;
    ...
    public String compile()
    {
        try
        {
            PrintWriter writer = new PrintWriter(""+dir+"/code.java");
            writer.println(code);
            writer.close();
            System.out.println("Began Compilation.");
            ProcessBuilder p;
            boolean val = true ;
            p = new ProcessBuilder("javac","code.java");
