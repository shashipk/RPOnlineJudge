...
public class CLang extends Language
{
    ...
    public CLang(String code, int i, String absolutePath, int index) 
    {
        this.code = code ;
        this.timeLimit = i ;
    ...
    public String compile()
    {
        try
        {
            PrintWriter writer = new PrintWriter(""+dir+"/code.c");
            writer.println(code);
            writer.close();
            //System.out.println("Began Compilation.");
            ProcessBuilder p;
            boolean val = true ;
            p = new ProcessBuilder("gcc","code.c","-o","code");
    ...
    public String runP()
    {
        ...
        p.directory(new File(dir));
        p.redirectErrorStream(true);
        File in = new File("/Users/Avishek/NetBeansProjects/judge1/p"+index+"/Input.txt") ;
        ...
        catch(IOException e)
        {
            ...
            Logger.getLogger(CLang.class.getName()).log(Level.SEVERE, null, ex);
        }
        return "RUN" ;
    }
    public String check()
    {
        ...
        try
        {
            File in = new File("/Users/Avishek/NetBeansProjects/judge1/p"+index+"/MyOutput.txt");
